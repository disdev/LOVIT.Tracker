...
public class WatchlistModel : PageModel
{
    ...
    public WatchlistModel(ILogger<IndexModel> logger, IParticipantService participantService, ISegmentService segmentService, ICheckinService checkinService, ILeaderService leaderService)
    {
        _logger = logger;
    ...
    public async Task<IActionResult> OnGetAsync()
    {
        ...
        Leaders = await _leaderService.GetLeadersByWatcherUserAsync(userId);
